...
from .views import index, solicitacao, vermais, negociacao, excluir_anuncio, cria_anuncio, meusanuncios, solicitacoesanuncio
...
urlpatterns = [
    ...
    path('solicitacoes/<int:pk>', solicitacoesanuncio, name='solicitacoes_anuncio')
]
