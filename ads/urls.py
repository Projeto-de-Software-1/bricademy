...
from .views import index, solicitacao, vermais, negociacao, excluir_anuncio, cria_anuncio
...
urlpatterns = [
    ...
    path('solicitacao/<int:anuncio>/<int:pk>', solicitacao, name="solicitacao_url"),
